...
$real_bild = addslashes(file_get_contents($_FILES["bild"]["tmp_name"]));

insertArticle($dbconnection,$_POST["name"],$_POST["preis"],$_POST["beschreibung"],$real_bild);

function insertArticle($conn,$name,$preis,$beschreibung,$bild){
    
$conn -> query("INSERT INTO artikel VALUES (0,'".$name."','".$preis."','".$beschreibung."','".$bild."');");
...
<body style="background-color: rgb(221, 219, 208);">
 ...
 <!-- Obere Navigationsleiste mit Shop-Name, Adminbereich und Konto -->
  ...
  <nav class="navbar navbar-expand-lg navbar-light" style="background-color: rgb(255, 255, 255);">
    ...
    <li class="nav-item">
    <a class="navbar-brand" href="../Entwicklung von Webapplikationen/Nutzer_Liste.html">Nutzer</a>
    </li>
    <li class="nav-item">
    <a class="navbar-brand" href="../Entwicklung von Webapplikationen/Warenkorb_Liste.html">Warenkörbe</a>
    </li>
    <li class="nav-item">
 ...
 <form id="form" action="article.php" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group" id="Bildhochladen">
     ...
     <div class="form-group" id="Textfeld">
      ...
      <text>Artikel erfolgreich hinzugefügt</text>
    </div>
     </div>
  </form>
  </body>
